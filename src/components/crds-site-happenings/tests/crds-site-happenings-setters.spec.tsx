...
describe('<crds-site-happenings> Setters', () => {
  ...
  describe('Tests validateSites()', () => {
    ...
    it('Checks non-string site names are removed', () => {
      ...
      const expected = [{ name: 'I do not attend Crossroads', id: '2' }, { name: 'Mason', id: '6' }];
    ...
    it('Checks excluded site names are removed', () => {
      ...
      const expected = [{ name: 'I do not attend Crossroads', id: '2' }, { name: 'Oakley', id: '1' }];
  ...
  describe('Tests setHappenings()', () => {
    it('Checks happenings are stored', () => {
      const promos = [
        ...
        {
          image: { url: 'https://images.ctfassets.net/groups.jpg' },
