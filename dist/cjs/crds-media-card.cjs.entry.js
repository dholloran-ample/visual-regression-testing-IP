...
class CrdsMediaCard {
    constructor(hostRef) {
        ...
        this.getLayout = () => {
            return {
                default: __chunk_1.h("crds-default-layout", Object.assign({}, this.childProps)),
                overlay: __chunk_1.h("crds-overlay-layout", Object.assign({}, this.childProps)),
                'media-object': __chunk_1.h("crds-media-object-layout", Object.assign({}, this.childProps))
            }[this.contentLayout];
        };
    }
    // ----------------------------------------------- | Validations
