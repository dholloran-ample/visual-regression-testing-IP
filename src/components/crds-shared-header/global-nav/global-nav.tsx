...
export class GlobalNav {
  ...
  // handleScroll(event) { //TODO can closeNav be used her instead???
  //   console.log('handleScroll');
  //   if(this.navNames.includes(this.openNavName)){
  //     return document.body.setAttribute('style', 'overflow: scroll;'), this.closeNav(event); //TODO this shouldn't be a return
  //   }
  // }
  ...
  containerClass(className, navName) {
    ...
    if (this.openNavName === navName) classes.push('nav-is-showing');
    return classes.join(' ');
  }
          ...
          <div>
            ...
            <div class="global-actions">
              ...
              <div class="user-actions">
                ...
                >
                  {this.maybeRenderIcons(profileIcons)}
                </a>
