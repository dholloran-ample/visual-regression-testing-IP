...
import { h } from './core-9036992e.js';
...
var ObservableQuery = (function (_super) {
    ...
    ObservableQuery.prototype.refetch = function (variables) {
        ...
        if (fetchPolicy === 'cache-only') {
            return Promise.reject(new InvariantError(3));
        }
...
var QueryStore = (function () {
    ...
    QueryStore.prototype.initQuery = function (query) {
        ...
        invariant(!previousQuery ||
            ...
            equal(previousQuery.document, query.document), 19);
...
var LocalState = (function () {
    ...
    LocalState.prototype.resolveDocument = function (document, rootValue, context, variables, fragmentMatcher, onlyRunForcedResolvers) {
        ...
        if (fragmentMatcher === void 0) {
            fragmentMatcher = function () { return true; };
        }
    ...
    StoreWriter.prototype.writeFieldToStore = function (_a) {
        ...
        if (!field.selectionSet || value === null) {
            ...
            if (dataIdFromObject) {
                ...
                invariant(!semanticId || !isGeneratedId(semanticId), 3);
                if (semanticId ||
            ...
            if (escapedId !== storeValue && isIdValue(escapedId)) {
                ...
                invariant(!generated || escapedId.generated || typenameChanged, 4);
                invariant(!hadTypename || hasTypename, 5);
...
function empty$1() {
    return new ApolloLink$1(function () { return Observable$2.of(); });
}
...
function empty$2() {
    return new ApolloLink$2(function () { return Observable$3.of(); });
}
...
function execute$2(link, operation) {
    return (link.request(createOperation$2(operation.context, transformOperation$2(validateOperation$2(operation)))) || Observable$3.of());
}
/**
...
var serializeFetchParameter = function (p, label) {
    ...
    try {
        ...
        var parseError = new InvariantError(2);
...
function CrdsApollo(authToken) {
    ...
    var httpLink = createHttpLink(Object.assign({ uri: "" }, (browser$2)));
    var authLink = setContext(function (_, _g) {
...
var GET_COPY = src(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\nquery contentBlocks($componentName: String) {\n  contentBlocks(filters: { category: $componentName }) {\n    content\n    slug\n  }\n}\n"], ["\nquery contentBlocks($componentName: String) {\n  contentBlocks(filters: { category: $componentName }) {\n    content\n    slug\n  }\n}\n"])));
var ContentBlockHandler = /** @class */ (function () {
    function ContentBlockHandler(apolloClient, componentName) {
        this.copy = [];
        this.apolloClient = apolloClient;
        this.componentName = componentName;
    }
    ContentBlockHandler.prototype.getCopy = function () {
        var _this_1 = this;
        return this.apolloClient
            .query({ query: GET_COPY, variables: { componentName: this.componentName } })
            .then(function (response) {
            _this_1.copy = response.data.contentBlocks;
            return response.data.contentBlocks;
        });
    };
    ContentBlockHandler.prototype.getContentBlock = function (slug) {
        if (!this.copy)
            return null;
        var contentBlock = this.copy.find(function (c) { return c.slug === slug; });
        if (!contentBlock)
            return;
...
export { CrdsApollo as C, ContentBlockHandler as a, global$1 as b, createCommonjsModule as c, commonjsGlobal as d, src as g, nextTick as n, process as p };
