...
export class GlobalNav {
  ...
  profileMenu() {
    const profHTML = `<div class="account-authenticated" style="background-image: url('${(this.auth.currentUser as any).avatarUrl}');"/>`;
    const accountIcon =
          ...
          <div>
            <div class="global-nav-items">
              <div class="global-actions">
                {this.renderNavLink(this.mainMenu())}

                {this.renderNavLink(this.searchLink())}
              </div>

              <nav-link href={this.rootURL()} automationId="sh-logo" class="logo" innerHTML={logo} />
