...
const CrdsGroupList = class {
    ...
    renderGroupList() {
        ...
        return groups.map(group => {
            return (h("div", { class: "group d-flex push-half-bottom" }, h("div", { class: "group-text" }, h("h4", { class: "list-header" }, h("a", { href: group.url }, group.name)), h("p", { class: "control-label text-gray-light flush" }, this.renderMeetingTime(group)), this.renderLeaderTag(group)), h("div", { class: "push-half-bottom group-image img-responsive img-circle", style: {
    ...
    renderGroupSkeleton() {
        return [1, 2, 3].map(() => (h("div", { class: "d-flex push-bottom" }, h("div", { class: "skeleton text-skeleton" }, h("div", { class: "title shimmer" }), h("div", { class: "subtitle shimmer" })), h("div", { class: "skeleton avatar-skeleton" }, h("div", { class: "shimmer" })))));
    }
    renderUserGreeting() {
        if (this.user) {
    ...
    render() {
        return (h("div", { class: "group-list" }, h("div", { class: "group-list-header text-gray-light font-family-base" }, this.contentBlockHandler.getContentBlock('group-list-header')), (() => {
            if (this.user)
