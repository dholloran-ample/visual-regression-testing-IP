...
export class NavSectionSubnav {
  @Prop({ mutable: true }) public active: string; //TODO this seems to be the active slug name? - better rename
  @Prop() public slug: string;
  @Prop() public onBack: Function;
//TODO this seems to only be visible on mobile. Is there a more descriptive name?
  render() {
    ...
    return (
      <div class={this.active == this.slug ? '' : ' hidden'}>
        <a
          href=""
          data-automation-id={`sh-section-subnav-${this.slug}`}
          class="back"
